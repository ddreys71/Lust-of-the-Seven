## Ce fichier contient les options qui peuvent être modifiées pour
...
define config.name = _("Lust of the Seven")
...
define build.name = "LustoftheSeven"
...
## transition. La valeur None indique qu’aucune transition ne doit être utilisée.
...
define config.save_directory = "LustoftheSeven-1764590230"
...
init python:
    ...
    ## Les fichiers correspondant au format de documentation sont dupliqués
    ## pour les compilation sur Mac, c'est pourquoi ils apparaissent deux fois
    ## dans l’archive zip.

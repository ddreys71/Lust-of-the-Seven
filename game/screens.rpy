...
## Écran des dialogues #########################################################
##
## L’écran des dialogues est utilisé pour afficher les dialogues du joueur.
## Il prend deux paramètres, who(qui) et what(quoi) qui sont respectivement le
## nom du personnage en train de parler et le texte à afficher. (Le paramètre
## who(qui) peut être None si aucun nom n’est donné.)
##
## Cet écran affiche le texte correspondant à what. Il peut également créer
## un texte avec le paramètre who et l’identifiant « window » est utilisé pour
...
## Écran « À propos... » #######################################################
##
## Cet écran présente le générique, les crédits et les informations de
## copyright relatives au jeu et à Ren’Py.
##
...
## Écran d'aide ################################################################
##
## Cet écran fournit des informations sur les touches et les boutons de
## souris. En interne, il utilise d’autres écrans (keyboard_help, mouse_help et
...
## Cette transformation est utilisé pour faire clignoter les flèches l’une
## après l’autre.
...
## Screen des bulles ###########################################################
##
## Le screen des bulles est utilisé pour afficher des dialogues en utilisant
## des bulles de dialogue. Ce screen prend les mêmes paramètres que le screen
## say, doit prévoir un displayable avec l'id "what", et peut créer des
## displayables avec les ids "namebox", "who", et "window".
##
